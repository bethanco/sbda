        ...
        <asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1">
            <ItemTemplate>
                <table cellpadding="0" cellspacing="0" border="0" class="mainTable " style="margin-left:100px; width: 678px;">
                    ...
                    <tr class="label">
                        <td class="textAlignLeft" style="width: 87px; height: 24px">
                            <asp:Label ID="lblEmpresa" runat="server" Text="Empresa:"></asp:Label></td>
                        <td class="controlContac left label" style="width: 191px; height: 24px">
                            <asp:TextBox ID="txtEmpresa" runat="server" MaxLength="50" Text='<%# Bind("EMPRESA") %>'></asp:TextBox></td>
                    </tr>
                    <tr class="label">
