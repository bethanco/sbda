<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listaPNorma.aspx.cs" Inherits="admin_listaPNorma" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0"  class="mainTable3 ">
                                <tr>
                                    ...
                                    <td class="cyan" style="width: 60px">
                                        <asp:HyperLink ID="lnkEditar" runat="server" NavigateUrl='<%# "~/admin/formPNorma.aspx?id=" + Eval("ID") %>' Width="85px">Editar</asp:HyperLink></td>
                                    <td class="cyan" style="width: 60px">
                                        <asp:HyperLink ID="lnkEliminar" runat="server" NavigateUrl='<%# "~/admin/listaPNorma.aspx?id=" + Eval("ID") %>'>Eliminar</asp:HyperLink></td>
                                </tr>
                            </table>
                        </ItemTemplate>
